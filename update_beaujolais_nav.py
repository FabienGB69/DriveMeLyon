...
source_html = '/home/user/splendid-carson/index.html'
target_html = '/home/user/splendid-carson/beaujolais-wine-tour-from-lyon/index.html'
...
# Prepend ../ to all hrefs except # and already-relative
...
print("✓ Nav updated in beaujolais page")
...
# 2. Grab reviews section from index.html (after section swap, reviews is now section 4)
...
if reviews_match:
    ...
    print("✓ Reviews section injected into beaujolais page")
else:
    print("⚠ Reviews section not found in index.html")
...
if '<h3 class="form-title">' in page_content:
    page_content = page_content.replace('<h3 class="form-title">', contact_block + '\n        <h3 class="form-title">')
    print("✓ Google trust block added")

with open(target_html, 'w', encoding='utf-8') as f:
    f.write(page_content)

print("\nbeaujolais-wine-tour-from-lyon/index.html updated successfully!")
