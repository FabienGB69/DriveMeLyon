        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 60" width="180" height="40" className="mb-5">
              ...
              <text x="12" y="48" fontFamily="'Inter', sans-serif" fontSize="7" fontWeight="600" fill="#C6A15B" letterSpacing="2.5">PRIVATE CHAUFFEUR & WINE TOURS</text>
            </svg>
          ...
          {/* Services */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-white border-l-2 border-[#C6A15B] pl-3 mb-5">
