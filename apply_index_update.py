...
file_path = '/home/user/splendid-carson/index.html'
...
if nav_old in content:
    ...
    print("⚠ Navigation pattern not found — skipping nav update")
...
if intl_match and reviews_match:
    ...
    print("✓ Sections swapped and updated")
else:
    print("⚠ Section patterns not found — skipping section swap")
...
if '<h3 class="form-title">' in content:
    content = content.replace('<h3 class="form-title">', contact_block + '\n        <h3 class="form-title">')
    print("✓ Google trust block added to contact form")
else:
    print("⚠ form-title not found — skipping trust block")

# 4. Header nav CTA update
content = re.sub(
...
# 5. Replace anchor links with page links
replacements = {
    'href="#booking"': 'href="contact/index.html"',
    'href="#experiences"': 'href="wine-tours/index.html"',
    'href="#fleet"': 'href="fleet/index.html"',
    'href="#reviews"': 'href="reviews/index.html"',
}
