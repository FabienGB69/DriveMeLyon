        ...
        <section className="bg-[#faf9f6] py-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <span className="text-xs font-semibold uppercase tracking-widest text-[#c5a880] mb-3 block">Unforgettable Journey</span>
                <h2 className="font-serif text-4xl text-[#0a0a0a] mb-6">A private, tailormade wine adventure</h2>
                <div className="space-y-4 text-gray-500 text-sm leading-relaxed">
                  ...
                  <p>The tour is available as either a <strong className="text-[#0a0a0a]">half-day (4-hour)</strong> or <strong className="text-[#0a0a0a]">full-day (8-hour)</strong> experience.</p>
                </div>
              </div>
              <div className="bg-white rounded-sm border border-[#c5a880]/20 shadow-md p-8">
                <h3 className="font-sans font-semibold text-[#c5a880] mb-5">Tour Highlights</h3>
                <ul className="space-y-4 text-sm text-gray-600">
                  {[
                    ...
                    <li key={label} className="flex gap-3">
                      ...
                      <div><strong className="text-[#0a0a0a]">{label}:</strong> {value}</div>
                    </li>
                  ))}
                </ul>
              </div>
