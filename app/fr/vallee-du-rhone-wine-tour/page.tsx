        ...
        <section className="bg-[#faf9f6] py-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <span className="text-xs font-semibold uppercase tracking-widest text-[#c5a880] mb-3 block">Pourquoi choisir la Vallée du Rhône</span>
                <h2 className="font-serif text-4xl text-[#0a0a0a] mb-6">Une aventure viticole mondialement reconnue</h2>
