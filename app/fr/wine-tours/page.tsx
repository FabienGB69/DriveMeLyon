...
export const metadata: Metadata = buildMetadata({
  title: "Wine Tours depuis Lyon | Beaujolais, Vallée du Rhône & Bourgogne",
  description:
    "Wine tours privés depuis Lyon avec chauffeur anglophone. Beaujolais, Vallée du Rhône Nord et Bourgogne — journée ou demi-journée, prise en charge hôtel, réservations domaines.",
  path: "/fr/wine-tours",
  alternatesLang: hreflangMap["/fr/wine-tours"],
});
